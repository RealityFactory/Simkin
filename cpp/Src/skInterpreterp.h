...
{   
 public:
    ...
    void makeMethodCall(skExecutable * obj,skRValue& robject,skRValueTable& var,const skString& method_name,skExprListNode * exprs,skRValue& ret);
    ...
    skRValue findValue(skExecutable * obj,skRValueTable& var,const skString& name,const skString& attribute); // tries to find a the value of the named variable
    ...
    bool extractValue(skExecutable * obj,skRValue& robject,const skString& name,const skString& attrib,skRValue& ret);
    bool insertValue(skExecutable * obj,skRValue& robject,const skString& name,const skString& attr,const skRValue& value);
...
//---------------------------------------------------
{
  // look for an initial "@" in a field name, and de-reference it if necessary
	...
	skRValue new_name=findValue(obj,var,ret,skString());
	ret=new_name.str();
    }
    return ret;
}	
