/*
  ...
  $Id: CSimkinApplication.cpp,v 1.2 2003/04/19 13:22:24 simkin_cvs Exp $
*/

#include "CSimkinApplication.h"
#include "CSimkinDocument.h"

const TUid KUidSimkin = { 0x101FB030 }; 
_LIT(KScriptFileName,"c:\\documents\\simkin\\SimkinDemo.xml");
