/*
  ...
  $Id: Demo_Controller.h,v 1.1 2003/01/23 14:22:09 simkin_cvs Exp $
*/
#ifndef CONTROLLER_H
#define CONTROLLER_H
...
class Controller : public skMSXMLExecutable, public ViewCallback
//	deriving from skMSXMLExecutable means we can be called from Simkin scripts
...
//	buttons are pressed on the view
{
 ...
 private:
  void	init();
  skString getStringAttribute(XMLElement elem,const skString& name);
  int getIntegerAttribute(XMLElement elem,const skString& name);
  View *	m_View;
  skString m_FileName;
